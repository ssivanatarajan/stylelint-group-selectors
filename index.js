...
module.exports = stylelint.createPlugin(ruleName, function(enabled) {
    ...
    return function(root, result) {
        ...
        root.walkRules(rule => {
            ...
            if (rule != undefined && rule.parent != undefined && rule.parent.type != 'atrule' && (!(selector.includes('-webkit-') || selector.includes('-moz-') || selector.includes('-o-') || selector.includes('-ms-')))) {
                var cssContent = "";
                var hashValue = 0;
                var cssArray = [];
